...
struct ArmFailureRemediationContext {
...
struct ArmFailureRemediationAdvice: Equatable {
...
enum ArmFailureAdvisor {

    static func advice(for context: ArmFailureRemediationContext) -> ArmFailureRemediationAdvice {
    ...
    private struct RemediationRule {
        ...
        let matches: (String, ArmFailureRemediationContext) -> Bool
        let makeAdvice: (ArmFailureRemediationContext) -> ArmFailureRemediationAdvice
    }
    ...
    private static func buildRules() -> [RemediationRule] {
        ...
        RemediationRule(
            ...
            makeAdvice: { ctx in
                ...
                return ArmFailureRemediationAdvice(
                    patternId: "ardupilot.accels_inconsistent",
    ...
    private static func defaultAdvice(haystack: String, context: ArmFailureRemediationContext) -> ArmFailureRemediationAdvice {
        var steps: [String] = [
