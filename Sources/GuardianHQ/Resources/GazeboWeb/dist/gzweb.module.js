...
import { DataTextureLoader, LinearMipmapLinearFilter, Loader, LoaderUtils, FileLoader, Vector3, Quaternion, Matrix4, MeshBasicMaterial, Scene as Scene$1, TextureLoader, Texture, Color as Color$1, MathUtils, AnimationClip, VectorKeyframeTrack, QuaternionKeyframeTrack, MeshLambertMaterial, MeshPhongMaterial, Vector2, DoubleSide, FrontSide, PerspectiveCamera, OrthographicCamera, AmbientLight, SpotLight, PointLight, DirectionalLight, BufferGeometry, Float32BufferAttribute, Skeleton, Bone, Group, LineBasicMaterial, SkinnedMesh, Mesh, Line, LineSegments, LinearEncoding, RGBAFormat, RepeatWrapping, ClampToEdgeWrapping, CompressedTextureLoader, RGB_ETC1_Format, RGBA_S3TC_DXT5_Format, RGBA_S3TC_DXT3_Format, RGB_S3TC_DXT1_Format, Material as Material$1, PointsMaterial, Points, DefaultLoadingManager, sRGBEncoding, EventDispatcher, MOUSE, TOUCH, Spherical, BufferAttribute, Interpolant, MeshPhysicalMaterial, TangentSpaceNormalMap, ImageBitmapLoader, InterleavedBuffer, InterleavedBufferAttribute, LinearFilter, MeshStandardMaterial, PropertyBinding, LineLoop, InterpolateLinear, Object3D, TriangleFanDrawMode, NearestFilter, NearestMipmapNearestFilter, LinearMipmapNearestFilter, NearestMipmapLinearFilter, MirroredRepeatWrapping, InterpolateDiscrete, TriangleStripDrawMode, NumberKeyframeTrack, Box3, Sphere, LoadingManager } from 'three';
        ...
        (error) => {
            if (this.findResourceCb) {
                ...
                this.findResourceCb(uri, (data, error) => {
                    ...
                    this.gltfLoader.parse(resourceContent, uri, (gltf) => {
                        let mesh = gltf.scene;
                        mesh.name = uri;
                        if (submesh && that.useSubMesh(mesh, submesh, centerSubmesh)) {
                            onLoad(mesh);
