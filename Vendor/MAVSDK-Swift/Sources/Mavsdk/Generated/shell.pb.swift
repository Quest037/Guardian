...
struct Mavsdk_Rpc_Shell_SendResponse {
  ...
  var shellResult: Mavsdk_Rpc_Shell_ShellResult {
    get {return _shellResult ?? Mavsdk_Rpc_Shell_ShellResult()}
    set {_shellResult = newValue}
  }
  /// Returns true if `shellResult` has been explicitly set.
  var hasShellResult: Bool {return self._shellResult != nil}
  /// Clears the value of `shellResult`. Subsequent reads from it will return its default value.
  mutating func clearShellResult() {self._shellResult = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _shellResult: Mavsdk_Rpc_Shell_ShellResult? = nil
}
...
extension Mavsdk_Rpc_Shell_ShellResult.Result: CaseIterable {
  ...
  static let allCases: [Mavsdk_Rpc_Shell_ShellResult.Result] = [
    .unknown,
    .success,
    .noSystem,
    .connectionError,
...
extension Mavsdk_Rpc_Shell_SendResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._shellResult) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._shellResult {
  ...
  static func ==(lhs: Mavsdk_Rpc_Shell_SendResponse, rhs: Mavsdk_Rpc_Shell_SendResponse) -> Bool {
    if lhs._shellResult != rhs._shellResult {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
